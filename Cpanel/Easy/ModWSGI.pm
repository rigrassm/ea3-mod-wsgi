...
our $easyconfig = { 
    ...
    'note'      => 'Adds support for Python WSGI modules for Apache 2.x only (EasyApache3 Custom Opt Mod Created by Ricky Grassmuck)'
    'hastargz'  => 1, 
        ...
        '0' => { 
            ...
            'command' => sub { 
                ...
                return $self->run_system_cmd_returnable([ 
                    qw(./configure --with-apxs=/usr/local/apache/bin/apxs) 
                ]); 
            }, 
        }, 
        '1' => { 
